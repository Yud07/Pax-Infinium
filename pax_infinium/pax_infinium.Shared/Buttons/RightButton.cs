...
namespace pax_infinium.Buttons
{
    public class RightButton : IButton
    {
        ...
        public RightButton(Vector2 pos)
        {
            int size = 40;
            ...
            desc = new Descriptor(poly, "Rotates the camera around the board clockwise.");
        }

        public void Click()
        {
            clickTime = DateTime.Now;
            Game1.world.level.grid.rotate(true, Game1.world.level);
        }
