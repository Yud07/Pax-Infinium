...
namespace pax_infinium.Buttons
{
    public class DownButton : IButton
    {
        ...
        public DownButton(Vector2 pos)
        {
            ...
            desc = new Descriptor(poly, "(Keyboard Down-Arrow) Lowers the peel (cube visibility) level.", sprite);
        }
        ...
        public void Click()
        {
            ...
            if (Game1.world.level.grid.peel < 0)
            {
                Game1.world.level.grid.peel = 0;
            }
