...
namespace pax_infinium.Buttons
{
    public class CancelButton : IButton
    {
        ...
        public CancelButton(Vector2 pos)
        {
            int width = 250;
            int height = 50;
            ...
            text = new TextItem(World.fontManager["Trajanus Roman 36"], "Cancel");
            ...
            desc = new Descriptor(poly, "(Keyboard N) Cancels the selected action.", sprite);
